...
def parse_dl_data(raw_data):
    ...
    field_map = {
        ...
        'DAJ': 'State',
        'DAK': 'ZIP Code',
        'DAL': 'Residence Address',
        'DAM': 'Residence Address Line 2',
        'DAN': 'Residence City',
        'DAO': 'Residence State',
        'DAP': 'Residence ZIP',
        'DAQ': 'License Number',
        ...
        'DCG': 'Country',
        'DCH': 'Federal Commercial Vehicle',
        'DCI': 'Place of Birth',
        'DCJ': 'Audit Information',
        'DCK': 'Inventory Control',
        'DCL': 'Race/Ethnicity',
        'DCM': 'Vehicle Classification',
        'DCN': 'Endorsement Code',
        'DCO': 'Restriction Code',
        'DCS': 'Last Name',
        'DCT': 'First Name',
        'DCU': 'Suffix',
        'DDA': 'Compliance Type',
        ...
        'DDL': 'Veteran',
        'PAA': 'Permit Class',
        'PAB': 'Permit Expiration',
        'PAC': 'Permit ID',
        'PAD': 'Permit Issue Date',
        'PAE': 'Permit Restrictions',
        'PAF': 'Permit Endorsements',
